  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <motion.div
        ...
        animate={isMobile ? { x: mobileOpen ? 0 : -280 } : { x: 0, width: expanded ? 280 : 80 }}
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Link
                          ...
                          onClick={() => isMobile && setMobileOpen(false)}
                        >
                          <span className="mr-2 text-gray-500">{category.icon || <Tag className="h-4 w-4" />}</span>
                          {expanded || isMobile ? (
                            <>
                          ...
                          <AnimatePresence>
                            {expanded || isMobile ? (
                              ...
                              >
                                <Badge
                                  variant="secondary"
                                  className="bg-red-500 text-white hover:bg-red-600 h-5 w-5 p-0 flex items-center justify-center rounded-full"
                                >
                                  {item.badge}
                                </Badge>
                              </motion.div>
